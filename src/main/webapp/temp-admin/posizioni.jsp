    ...
    <body class="bg-body-tertiary">
        ...
        <section style="height: 100vh;">
            <div class="container-fluid p-4">
                ...
                <span class="">
                    <div id="template_posizione" class="card" style="width: 450px;">
                        <img src="https://picsum.photos/450/300" class="card-img-top">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-around align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <span class="badge text-bg-success text-light">Aperta</span>
    
                                    <span class="badge text-bg-danger text-light">Chiusa</span>
                                </div>
                            </div>
                            <span class="m-2"></span>
