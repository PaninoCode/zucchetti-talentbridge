<%@ page contentType="text/html;charset=UTF-8" session="false" %>
    ...
    <body class="bg-body-tertiary">
                            ...
                            <div class="accordion-body p-4">
                                <form id="register_steps_form_step_two" class="needs-validation" novalidate>
                                    ...
                                    <div class="position-relative form-check mb-4">
                                        ...
                                        <label class="form-check-label" for="validationFormCheck1">Accetto la Politica
                                            sulla
        ...
        <script>
            ...
            let registerFormSpinner = document.querySelector('#register_form_spinner');
            ...
            registerStepTwoForm.addEventListener('submit', e => {
                ...
                if (registerStepTwoForm.checkValidity()) {
                    registerFormSpinner.classList.remove('d-none');
