...
/**
 * Servlet implementation class InsertCategoryWithSkills
 */
@WebServlet("/user/insert-category-and-skills")
public class InsertCategoryWithSkills extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	CategorySkillsService.insertCategoryWithSkills(jsonContent.toString(), profilo.getIdCv());
