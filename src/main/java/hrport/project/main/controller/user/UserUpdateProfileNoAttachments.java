...
/**
 * Servlet implementation class UserUpdateProfileNoAttachments
 */
@WebServlet("/user/update-profile-no-attachments")
public class UserUpdateProfileNoAttachments extends HttpServlet {
