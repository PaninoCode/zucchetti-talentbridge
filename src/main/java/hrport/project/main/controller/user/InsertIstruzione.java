...
/**
 * Servlet implementation class InsertIstruzione
 */
@WebServlet("/user/insert-istruzione")
public class InsertIstruzione extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	IstruzioneService.insertIstruzInfo(jsonContent.toString(), profilo.getIdCv());
