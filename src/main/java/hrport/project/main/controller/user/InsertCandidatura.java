...
/**
 * Servlet implementation class InsertCandidatura
 */
@WebServlet("/user/insert-candidatura/*")
public class InsertCandidatura extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	CandidaturaService.insertCandidatura(idPos, idUtente);
