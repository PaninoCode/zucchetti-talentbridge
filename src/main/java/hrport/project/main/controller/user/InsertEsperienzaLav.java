...
/**
 * Servlet implementation class InsertEsperienzaLav
 */
@WebServlet("/user/insert-esperienza")
public class InsertEsperienzaLav extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	EspLavorativaService.insertEsperienza(jsonContent.toString(), profilo.getIdCv());
